The following is a list of assets used in the bitcoinquality source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://bitcoinqualitytalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original bitcoinquality logo from Bitboy)
* License: MIT
